...
function add_circleMarker(lat, lng, placename, popup, photoname){
    L.circleMarker([lat, lng], {"radius": 4, "color": "#FD3A4A", "weight": 3, "opacity": 1}).addTo(map).bindPopup(`<h2 class="spacing2">${placename}</h2> 
    <h3>${popup}</h3><img class="center" src=${photoname}>`)
}
